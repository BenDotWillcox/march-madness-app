...
function createFirstFourGames(): BracketGame[] {
  return [
    ...
    },
    {
      ...
      round: "first_four",
      region: "national",
      home: createSlot(16, "(16) First Four Team C"),
      away: createSlot(16, "(16) First Four Team D"),
      winnerTeamId: null,
      winnerSourceLabel: null,
      nextGameId: "west-r64-1",
      nextSlot: "away",
      gameInfo: emptyGameInfo(),
    },
    {
      ...
      round: "first_four",
      region: "national",
      home: createSlot(11, "(11) First Four Team A"),
      away: createSlot(11, "(11) First Four Team B"),
      winnerTeamId: null,
      winnerSourceLabel: null,
      nextGameId: "south-r64-5",
      nextSlot: "away",
      gameInfo: emptyGameInfo(),
    },
    {
